...
Chap 17 Sector Regulation
- Between cost-plus and fixed price contracts, FP is often considered as more efficient but allows an opportunity for the company to make big profits, rents and potential government confiscation. 
- Ex post competition: if the authority can repalce at a low cost the contractor with a competing company, esp. if it owns the rolling stocks (but it will raise the problem in purchasing and maintenance and related agent problem), the trains are standardized.
- Who should cover the fixed costs, users or taxpayers? Suppose a company prices its products at marginal costs, it will make no profits in sales and a loss equal to the fixed cost. The author suggest cover the fixed costs from profits on services with the least elastic demand.
- Cross-subsidies: Public service obligations force those living the areas that cost little to serve to subsidize those who live in areas that are most costly to serve. Such universal service provider can lose to the local service provider without such obligation.

Epilogue
- Populism comes in many guises and always plays on the electorate's frustrations (unemployment, immigration, slowdown of economic growth) and fears for the future (rising debt, job-destroying tech, climate change). 
- There is no doubt that citizens want change. But change of change's sake esp. when it is based on prejudice and selfishness is extremely dangerous. Steady, thoughtful change is much less exciting than fast, dramatic change (that often promote a vision free of difficult choices). And we citizens get the policies we deserve.
- 
